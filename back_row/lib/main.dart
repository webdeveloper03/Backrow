...
import 'package:back_row/ui/login/splash_screen.dart';
import 'package:back_row/ui/login/splash_screen.dart';
import 'package:back_row/ui/login/verify_account_screen.dart';
    ...
    return MaterialApp(
      ...
      home: Container(
        decoration: BoxDecoration(
            ...
            ColorConstant.layoutGradient1,
            ColorConstant.layoutGradient2,
            ColorConstant.layoutGradient3,
          ])
        ),
          child: SplashScreen()),
    );
...
class AudioMetadata {
  ...
  AudioMetadata(
      { this.album,  this.title,  this.artwork});
}
