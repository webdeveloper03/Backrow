...
class SiteOverviewDataPage extends StatefulWidget {
  final int selectedIndex;

  SiteOverviewDataPage({this.selectedIndex});

  @override
  _SiteOverviewDataPageState createState() => _SiteOverviewDataPageState();
}

class _SiteOverviewDataPageState extends State<SiteOverviewDataPage> {
  @override
  void initState() {
    super.initState();
  }
                    ...
                    if (snapshot.data[0].itemsList.length == 0)
                      ...
                      Container(
                        ...
                        child: Card(
                          ...
                          child: Container(
                            height:getHeight11(snapshot.data),
                            child: Column(
                                                                    ...
                                                                    child: Container(
                                                                      ...
                                                                      child: Text(
                                                                        ...
                                                                        style: TextStyle(
                                                                            ...
                                                                            0]
                                                                                .itemsList[
                                                                            index].highLight=="1")?16:15,
                                                                            fontWeight:
                                                                            ( snapshot
                                                                                .data[
                                                                            0]
                                                                                .itemsList[
                                                                            index].highLight=="1")?FontWeight.w600:FontWeight.normal),
                                                                      ),
                                                                    ),
                                                                  ),
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Container(
            width: 6,
            margin: EdgeInsets.only(top: 53,left: 122),
            child: ListView.builder(
                physics: NeverScrollableScrollPhysics(),
                padding: EdgeInsets.all(0),
                scrollDirection: Axis.vertical,
  ...
  getHeight11(data) {
    ...
    return  ((widget.selectedIndex == 1) ? 40.0 : 0.0) +
        100.0 +
        (data[0].itemsList.length * 120);
  }
}
